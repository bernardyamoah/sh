	...
	let Links = [
		{
			name: "Home",
			link: "/",
			icon: <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" className="w-6 h-6 mb-1 text-gray-900 dark:text-gray-400 group-hover:text-emerald-600 dark:group-hover:text-emerald-500"
		...
		},
		{
			name: "Programs",
			link: "/programmes",
			icon: <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mb-1 text-gray-900 dark:text-gray-400 group-hover:text-emerald-600 dark:group-hover:text-emerald-500"
		...
		<>
			<div class="fixed md:hidden bottom-0 left-0 z-50 w-full h-16 bg-white  border-t border-gray-200 dark:bg-gray-900 dark:border-gray-600">
				<div class="grid h-full max-w-xl grid-cols-5 mx-auto">
					...
					>
						{link.icon}
						<span class="text-xs text-gray-600 dark:text-gray-400 group-hover:text-emerald-600 dark:group-hover:text-emerald-500">
						{link.name}
						</span>
					</Link>
					))}
